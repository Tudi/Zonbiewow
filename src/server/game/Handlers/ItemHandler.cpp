...
void WorldSession::HandleSellItemOpcode(WorldPacket& recvData)
{
    ...
    if (pItem)
    {
        ...
        if (pProto)
        {
            ...
            {
                CP_ITEM_USE_DENY IUD(GetPlayer(), pItem, creature);
                TriggerCallbackFunctions(CALLBACK_TYPE_SELL_ITEM, &IUD);
...
void WorldSession::SendListInventory(ObjectGuid vendorGuid)
{
    ...
    if (_player->isFreeArenaVendor(vendor))
        vendor->Whisper(std::string("My items are free for you!"), LANG_UNIVERSAL, _player);
