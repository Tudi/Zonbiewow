...
void WorldSession::HandleMoveWorldportAck()
{
    ...
    Map* newMapNoScript = newMap;

    TriggerCallbackFunctions(CALLBACK_TYPE_PLAYER_MAP_CHANGE, &CP_MAP_CHANGED(GetPlayer(), newMap, &newMap));
    ...
    if (!newMap || (newMapNoScript == newMap && newMap->CannotEnter(GetPlayer())))
    {
