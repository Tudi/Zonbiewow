...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_NPC_SET_SCALE                          = 874,
    RBAC_PERM_COMMAND_GOBJECT_SCALE                          = 875,
    //
    // IF YOU ADD NEW PERMISSIONS, ADD THEM IN MASTER BRANCH AS WELL!
    //
    // custom permissions 1000+
    RBAC_PERM_COMMAND_EVENTS_RELOAD     = 1001, //reload events - Admin Required
    RBAC_PERM_COMMAND_EVENTS            = 1002, //show events
    RBAC_PERM_COMMAND_EVENTS_NEXT       = 1003, //show next events
    RBAC_PERM_COMMAND_HOME              = 1004, //Alias for Personal Instance
    RBAC_PERM_COMMAND_HOME_ENTER        = 1005,
    RBAC_PERM_COMMAND_HOME_ADDNPC       = 1006,
    RBAC_PERM_COMMAND_HOME_DELNPC       = 1007,
    RBAC_PERM_COMMAND_HOME_ADDGO        = 1008,
    RBAC_PERM_COMMAND_HOME_SELGO        = 1009,
    RBAC_PERM_COMMAND_HOME_DELGO        = 1010,
    RBAC_PERM_COMMAND_HOME_FLY          = 1011,
    RBAC_PERM_COMMAND_TRANSMOG_XMOG     = 1012,
    RBAC_PERM_COMMAND_XMORPH            = 1013,
    RBAC_PERM_COMMAND_XMORPH_SELF       = 1014,
    RBAC_PERM_COMMAND_XMORPH_PET        = 1015,
    RBAC_PERM_COMMAND_XMORPH_COMP       = 1016,
    RBAC_PERM_COMMAND_XMORPH_MOUNT      = 1017,
    RBAC_PERM_COMMAND_LOOT              = 1018,
    RBAC_PERM_COMMAND_XRESET            = 1019,
    RBAC_PERM_COMMAND_WORLD_CHAT        = 2000,
