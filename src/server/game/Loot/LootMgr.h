...
struct TC_GAME_API LootStoreItem
{
    ...
    bool Roll(bool rate,Player *lootOwner=NULL) const;                             // Checks if the entry takes it's chance (at loot generation)
...
class TC_GAME_API LootTemplate
{
    ...
    public:
        ...
        void Process(Loot& loot, bool rate, uint16 lootMode, uint8 groupId = 0, Player *lootOwner = NULL) const;
