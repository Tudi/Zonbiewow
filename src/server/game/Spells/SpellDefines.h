...
enum TriggerCastFlags : uint32
{
    ...
    TRIGGERED_IGNORE_CAST_TIME                      = 0x00004000,   // only spells with cast time have movement checks
    TRIGGERED_IGNORE_MOVE_CHECK                     = 0x00008000,   // do not delay cast triggered spells while moving
    ...
    TRIGGERED_FULL_MASK                             = (0x0007FFFF & (~TRIGGERED_IGNORE_CAST_TIME) & (~TRIGGERED_IGNORE_MOVE_CHECK)),   //! Used when doing CastSpell with triggered == true
