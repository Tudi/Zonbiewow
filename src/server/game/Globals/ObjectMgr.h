...
class TC_GAME_API ObjectMgr
{
    ...
    public:
        ...
        void UpdateCreatureAddon(ObjectGuid::LowType lowguid, CreatureAddon const *NewValues);
        void UpdateGameObjectAddon(ObjectGuid::LowType lowguid, GameObjectAddon const *NewValues);
