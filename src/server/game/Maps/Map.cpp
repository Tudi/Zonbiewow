...
void Map::Update(uint32 t_diff)
{
    ...
    TriggerCallbackFunctions(CALLBACK_TYPE_MAP_PERIODIC_UPDATE, &CP_MAP_PERIODIC_UPDATE(this, t_diff));
}
...
//        else
            ...
            respawnTime = GameTime::GetGameTime() + MONTH * 10;
...
{
    //respawn time should be reasonable or there is no reason to save it at all
    ASSERT(respawnTime != std::numeric_limits<time_t>::max() && respawnTime + 10000 >= GameTime::GetGameTime());
